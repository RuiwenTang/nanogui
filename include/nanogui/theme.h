...
class NANOGUI_EXPORT Theme : public Object {
 public:
  ...
  std::shared_ptr<skity::Typeface> mFontNormal;
  /// The bold font face (default: ``"sans-bold"`` from
  /// ``resources/roboto_regular.ttf``).
  std::shared_ptr<skity::Typeface> mFontBold;
  /// The icon font face (default: ``"icons"`` from ``resources/entypo.ttf``).
  std::shared_ptr<skity::Typeface> mFontIcons;
  /**
   ...
   * (default: intensity=``0``, alpha=``128``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mDropShadow;
  /**
   * The transparency color
   * (default: intensity=``0``, alpha=``0``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mTransparent;
  /**
   * The dark border color
   * (default: intensity=``29``, alpha=``255``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mBorderDark;
  /**
   * The light border color
   * (default: intensity=``92``, alpha=``255``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mBorderLight;
  /**
   * The medium border color
   * (default: intensity=``35``, alpha=``255``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mBorderMedium;
  /**
   * The text color
   * (default: intensity=``255``, alpha=``160``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mTextColor;
  /**
   * The disable dtext color
   * (default: intensity=``255``, alpha=``80``; see \ref
   * nanogui::Color::Color(int,int)).
   */
  Color mDisabledTextColor;
  /**
   * The text shadow color
   * (default: intensity=``0``, alpha=``160``; see \ref
   * nanogui::Color::Color(int,int)).
   */
   ...
   * (default: intensity=``50``, alpha=``255``; see \ref
   * nanogui::Color::Color(int,int))).
   */
  Color mWindowPopup;
  /**
   * The transparent popup window color
   * (default: intensity=``50``, alpha=``0``; see \ref
   * nanogui::Color::Color(int,int))).
   */
